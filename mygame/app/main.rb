def tick args
  ...
  if args.inputs.keyboard.m && !args.state.making_sound
    ...
    wave_data = generate_sine_wave frequency: 410.0,
                                   duration: 300,
                                   fade_out: true
    args.audio[:audio1] = {
    ...
    wave_data = generate_sine_wave frequency: 420.0,
                                   duration: 300,
                                   fade_out: true
    args.audio[:audio2] = {
      input: [1, 48000, wave_data],
  ...
  if args.state.dragon.x > (args.state.world.w - 1280)
    args.state.dragon.x = 200
  end

  if args.inputs.right
    args.state.dragon.x += VELOCITY
